...
export default function Footer() {
  ...
  return (
    ...
    >
      <div>
        <div ref={socialRef} className="grid grid-flow-col gap-4 mt-4">
          <a
      ...
      <div className="border-t border-base-300 w-full pt-4">
        <p className="text-sm">© 2025 Marlou Tadlip. All rights reserved.</p>
      </div>
    </footer>
  );
}
